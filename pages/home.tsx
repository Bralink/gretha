        ...
        <Container style={{marginTop: '-20px'}} fluid>
            ...
            <Carousel interval={50000} variant="dark">
                <Carousel.Item>
                    ...
                    <Carousel.Caption style={{height: '90%', width: '85%', left: '90px'}}>
                        <Row>
                            <Col md={4}>
                                <Image  
                                    src="/images/corazon_doctores.gif"
                                    alt="Corazon"
                            ...
                            <Col md={8}>
                                ...
                                <Row md={1} style={{paddingBottom: '20px', paddingTop: '15px'}}>
                                    <Col>
                                        <p style={{fontSize: '13px', textAlign: 'justify', paddingTop: '20px'}}>
                                        ...
                                        <p style={{fontSize: '13px', textAlign: 'justify',  paddingTop: '20px'}}>
                                            ...
                                            el presente ciclo de video cápsulas: <b>Hipertensión arterial. Diálogo con los expertos</b> con la firme convicción que el
                                ...
                                <Row className="rowSlider1" >
                                    <Col md={2}>
                                        <p style={{color: '#2c62e9', paddingTop: '20px', fontSize: '14px'}}>Con aval de:</p>           
                                    </Col>
                                    <Col md={3}>
                                        <Image src="/images/logo_asociacion.png" alt="asociacion" style={{width: '40%', paddingTop: '10px'}}/>
                                    </Col>
                                    <Col md={2}>
                                        <Image src="/images/logo_grehta.png" alt="asociacion" style={{width: '160%', paddingTop: '10px', marginLeft: '-35px'}}/>
                                    </Col>
                                    <Col md={3}>
                                        <Image src="/images/logo_conamege.png" alt="Conamege" style={{width: '70%', paddingTop: '10px'}}/>
                                    </Col> 
                                    <Col md={2}>
                                        <Image src="/images/12puntos.png" alt="12 Puntos" style={{width: '90%', paddingTop: '20px'}}/>
                                    </Col>        
                                </Row>
                            </Col>
                        </Row>
                                ...
                                <Row md={1} style={{paddingBottom: '20px', paddingTop: '15px'}}>
                                    <Col>
                                        <p style={{fontSize: '12px', textAlign: 'justify', paddingTop: '10px'}}>
                                            <span style={{display: 'block', color: '#e63a52', fontSize: '17px', fontWeight: 'bold', paddingBottom: '5px'}}>GREHTA</span>
                        ...
                        <Row>
                            ...
                            <Col md={8}>
                                <Row md={1} style={{paddingBottom: '20px', paddingTop: '15px'}}>
                                    <Col>
                                        <p style={{fontSize: '12px', textAlign: 'justify', paddingTop: '10px'}}>
                                            <span style={{display: 'block', color: '#e63a52', fontSize: '17px', fontWeight: 'bold', paddingBottom: '5px'}}>RIHTA</span>
                                        ...
                                        <p style={{fontSize: '12px', textAlign: 'justify'}}>
                                            Es una plataforma innovadora que cuenta con datos complementarios considerando: El daño a órgano blanco | Estimar función renal | Registro domiciliario para perﬁl metabólico | Riesgo cardiovascular | Adherencia al tratamiento | Percepción del paciente sobre la enfermedad
                                        </p>
                                        <p style={{fontSize: '12px', textAlign: 'justify'}}>
                                            Los invitamos a sumarse a RIHTA,  inscribiendo a sus pacientes.
                                            <span style={{display: 'block', color: '#e63a52', fontSize: '15px', fontWeight: '600', paddingTop: '10px', textAlign: 'center'}}>¡Visítanos!</span>
                ...
                <Carousel.Item>
                    ...
                    <Carousel.Caption style={{height: '90%', width: '85%', left: '90px'}}>
                        <Row>
                            <Col md={3} style={{borderRight: '1px solid gray', paddingTop: '10%'}}>
                                <span style={{color: 'gray', display: 'block', paddingBottom: '8%', marginLeft: '-30px', fontWeight: 'bold'}}>Con el apoyo de:</span>
                            ...
                            <Col md={9}>
                                <Row xs={1} md={3}>
                                        <Col style={{height: '100px'}}>
                                            <a href="https://www.actuamed.com.mx/marca/29796" style={{display: 'flex', marginLeft: '10%'}} target="_blank" rel="noopener noreferrer">
                                                <Image  
                                                    className="d-block "
                                        ...
                                        <Col style={{height: '100px'}}>
                                            <a href="https://www.actuamed.com.mx/marca/15640" style={{display: 'flex', marginLeft: '10%'}} target="_blank" rel="noopener noreferrer">
                                                <Image  
                                                    className="d-block "
                                        ...
                                        <Col style={{height: '100px'}}>
                                            <a href="https://www.actuamed.com.mx/marca/24285" style={{display: 'flex', marginLeft: '10%'}} target="_blank" rel="noopener noreferrer">
                                                <Image  
                                                    className="d-block "
