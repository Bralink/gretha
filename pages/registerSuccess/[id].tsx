                ...
                <Col md={4}>
                    ...
                    {!bandera &&(
                        <Col md={4} style={{backgroundColor: '#EBE8EC', borderRadius: '1em', padding: '20px'}}>
                            <Row md={1} xs={1}>
                                <Col>
                                    <p style={{color: '#e63a52', textAlign: 'center', fontWeight: '600'}}>Su registro se ha completado, hemos enviado un código de verificación al correo proporcionado, ingréselo a continuación para iniciar sesión</p>
                                    <p style={{color: '#e63a52', textAlign: 'center', fontWeight: '600'}}> EN OCACIONES EL CORREO DE VERIFICACIÓN LLEGA A BANDEJA DE NO DESEADOS</p>
                                </Col>
                            </Row>
                            <Row md={1} xs={1}>
                                <Col>
                                    ...
                                    <Form noValidate validated={formValidatedCode} onSubmit={validateForm}>
                                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                            <Row>
                                                <Col md={2}></Col>
                                                <Col md={8}>
                                                    <Form.Label style={{color: '#ef7953'}}>Ingrese su código</Form.Label>
                                                    <Form.Control 
                                                        type="number"
                                                        placeholder="0000"
                                                        onChange={(event:any) => {
